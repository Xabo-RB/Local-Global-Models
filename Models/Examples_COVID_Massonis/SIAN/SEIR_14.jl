...
ode = @ODEmodel(
    ...
    Q'(t) = delta*I(t)-(1-lambda_0*exp(-lambda_1*lambda(t)))*Q(t)-(k_0*exp(-k_1*k(t)))*Q(t)-mu*Q(t),
    R'(t) = (1-lambda_0*exp(-lambda_1*lambda(t)))*Q(t)-mu*R(t),
    D'(t) = (k_0*exp(-k_1*k(t)))*Q(t),
    C'(t) = alpha*S-mu*C(t)-tau*C(t),
    y1(t) = Q(t),
    y2(t) = D(t),
    y3(t) = C(t)
)
